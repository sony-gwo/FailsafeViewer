    ...
    function iQInfoClass (){
        ...
        function showIqInfo(){
            ...
            $(".iq-img").each(function(index,elm){
                ...
                infoString += "<span class='p2'>Desktop:</span> <a title='Non-retina size' href=\""+$(elm).data("src-desktop")+"\" target=\"_blank\">"+ wid+" "+hei + "px (Non-Retina)</a>, ";
                ...
                infoString += "<a title='Retina size' href=\""+$(elm).data("src-desktop-highres")+"\" target=\"_blank\">"+ wid+" "+hei + "px (Retina)</a>, ";
                infoString += "<a title='See Original Size' href=\""+desktopSourceUrl+"\" target=\"_blank\">Original Size</a> <br>";
                //
                ...
                infoString += "<span class='p2'>Tablet:</span> <a title='Non-retina size' href=\""+$(elm).data("src-tablet")+"\" target=\"_blank\">"+ getURLParameter($(elm).data("src-tablet"), "wid") + "px (Non-Retina)</a>, ";
                ...
                infoString += "<a title='Retina size' href=\""+$(elm).data("src-tablet-highres")+"\" target=\"_blank\">"+ getURLParameter($(elm).data("src-tablet-highres"), "wid")+ "px (Retina)</a>, ";
                infoString += "<a title='See Original Size' href=\""+tabletSourceUrl+"\" target=\"_blank\">Original Size</a> <br>";
                //
                ...
                infoString += "<span class='p2'>Phone:</span> <a title='Non-retina size' href=\""+$(elm).data("src-phone")+"\" target=\"_blank\">"+ getURLParameter($(elm).data("src-phone"), "wid") + "px (Non-Retina)</a>, ";
                ...
                infoString += "<a title='Retina size' href=\""+$(elm).data("src-phone-highres")+"\" target=\"_blank\">"+ getURLParameter($(elm).data("src-phone-highres"), "wid")+ "px (Retina)</a>, ";
                infoString += "<a title='See Original Size' href=\""+phoneSourceUrl+"\" target=\"_blank\">Original Size</a>";
                //
